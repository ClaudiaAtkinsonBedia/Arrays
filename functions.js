...
console.log(indice);
    ...
    function validarDNI() 
    {
        ...
        else if (!regexDNI.test(dni)) // Si el DNI que escriben no coincide con la expresión regular
        {
    ...
    function validarTarjeta()
    {
        ...
        var direccion = document.getElementById("direccion"); // Cogemos el id de la dirección            var pais = document.getElementById("pais"); // Cogemos el id del país
